...
public class CreateCustomerOrderTest extends BaseClass {
	...
	//private CashierReceiptPageTest cashier;
	...
	@Test(priority = 0,groups = {"Regression"},dataProvider="createCustomerOrderPageData",dataProviderClass=SalesDataProvider.class)
	public void verifyCustomerOrderOrderKindNo(HashMap<String, String> hashMapValue) throws Throwable {
		...
		Log.startTestCase("Verifying customer order order kind NO without stones and accessory");
		...
		Log.endTestCase("Verifying customer order order kind NO without stones and accessory");
